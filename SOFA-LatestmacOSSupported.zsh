...
# by Balz Aschwanden
#
# Modified by @robjschroeder to check compatibility between last two OSes (i.e., as of 5/1/2024 Sonoma and Ventura)
#
...
latest_os_n1=$(/usr/bin/plutil -extract "OSVersions.1.OSVersion" raw -expect string - - <<< "$json_data" | /usr/bin/head -n 1)
...
# Echo out the latestOSSupported
